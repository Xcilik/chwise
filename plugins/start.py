...
from helper_func import decode, get_messages, subsall, subsch, subsch2, subsch3
...
@Bot.on_message(filters.command("start") & filters.private & subsall & subsch & subsch2 & subsch3)
